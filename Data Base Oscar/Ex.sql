...
UPDATE movies set category = 'Best Film In The World' where ceremony = '93';
RESPOSTA:
...
SELECT year_ceremony, category, film, name from movies where category in ('BEST PICTURE','ACTRESS','DIRECTING') and year_ceremony ='1993' and winner like '1';
